...
/*In Flutter and Dart,
you use the Color class with a hexadecimal integer to define colors.
The color code should be prefixed with (0xFF)
...
const Color parkingSpacesCardColor = Color(0xFFF3F3F3);
