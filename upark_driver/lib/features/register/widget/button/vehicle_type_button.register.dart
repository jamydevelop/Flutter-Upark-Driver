...
import 'package:upark_driver/features/register/widget/text_label/vehicle_type_text_label.register.dart';

class VehicleTypeButtonRegister extends StatefulWidget {
  const VehicleTypeButtonRegister({super.key, required this.dropDownCallback});

  final Function({required String value}) dropDownCallback;

  @override
  State<VehicleTypeButtonRegister> createState() =>
      _VehicleTypeButtonRegisterState();
}

class _VehicleTypeButtonRegisterState extends State<VehicleTypeButtonRegister> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        VehicleTypeTextLabelRegister(), //Title
